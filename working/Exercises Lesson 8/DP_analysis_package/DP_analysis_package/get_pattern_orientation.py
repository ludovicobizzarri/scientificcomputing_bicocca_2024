...
def fit_emcee_cen(x,y,sx,sy,sigmax,sigmay,image):
    ...
    plt.savefig(r"c:\Users\Ludovico\Desktop\unimib\PhD\Scientific Computing\scientificcomputing_bicocca_2024\working\Exercises Lesson 8\DP_analysis_package\DP_analysis_package\result_images\pattern_orientation%f.jpg"%values_emcee[1], format='jpg')
